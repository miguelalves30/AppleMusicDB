...
DROP TABLE IF EXISTS USER,PAYMENT,PLAYLIST,LISTENS,MUSIC,ARTIST,HEARS,GENRE,CONTAINS,FOLLOWS;
...
(
  IdUser 			  INT NOT NULL,
  Method 			  ENUM('Paypal','MasterCard', 'Visa', 'American Express' , 'Discover') NOT NULL,
...
INSERT INTO
  PLAYLIST( IdPlaylist, IdUser, Name)
VALUES
  (1, 1 , 'Chill'); /* Playlist Chill by Miguel Alves*/
INSERT INTO
  PLAYLIST( IdUser, Name)
VALUES
...
VALUES
  (1, 1), /*USER Miguel Alves listens to Chill*/
  (1, 2), /* USER Miguel Alves listens to ***core*/
  (2, 3), /*etc*/
  (3, 4),
  (4, 5),
  (5, 6),
...
VALUES
  ...
  ('The Eagle Flies Alone - edit'	 					, 'Will To Power'              				      	,14),    /*18*/
  ('Polly'                      						, 'Nevermind'                   				  	,15),
...
(22, 9),
(23,10),
(24,10);       /*All musics (excluding 'Brasileirada' ones) are recommended. Feel free to give it a try */
